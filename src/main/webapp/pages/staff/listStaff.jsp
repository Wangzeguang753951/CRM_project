...
<table width="100%" border="1" >
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:iterator value="staff" var="staffs">

	  <tr class="tabtd2">
	    <td align="center">${staffs.staffName}</td>
	    <td align="center">${staffs.gender}</td>
	    <td align="center">${staffs.onDutyDate}</td>
	    <td align="center">${staffs.dept.deptName}</td>
	    <td align="center">${staffs.post.postName}</td>
	  	<td width="7%" align="center">
